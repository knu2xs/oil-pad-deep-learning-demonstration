...
Object detection using deep learning for oil pads in the permian basin.

## Quickstart

Clone or download the project. Create the conda environment by running `make env` from the command line in the project root directory. 
...
```
    ...
    ├── setup.py           <- Setup script for the library (oil_pad)
    ...
    │   ├── oil-pad-detection.aprx <- ArcGIS Pro project.    
    │   └── oil-pad-detection.tbx  <- ArcGIS Pro toolbox associated with the project.
    ...
    └── src                <- Source code for use in this project.
        └── oil_pad <- Library containing the bulk of code used in this 
                                                  project. 
```
